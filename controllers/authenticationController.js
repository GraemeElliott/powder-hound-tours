...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (currentUser.changePassword(decodedPayload.iat)) {
    return next(
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `Forgot your password? Submit a PATCH request with your nw password and password Confirm to: ${resetURL}.\n If you didn't forget your password then ignore this email`;
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 2) Reset if token has not expired
  if (!user) {
