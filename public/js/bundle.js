    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/users/update-password' : 'http://127.0.0.1:3000/api/users/update-profile';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var logoutButton = document.querySelector('.nav__el.nav--logout');
...
if (userDataForm) userDataForm.addEventListener('submit', function (element) {
